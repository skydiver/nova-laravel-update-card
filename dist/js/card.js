...
Nova.booting(function (Vue, router, store) {
    Vue.component('nova-update-card', __webpack_require__(2));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        ...
        Nova.request().get('/nova-vendor/skydiver/nova-update-card/check').then(function (_ref) {
            var data = _ref.data;

            _this.latestVersion = data.latest_version;
            _this.currentVersion = data.current_version;
            _this.updateAvailable = data.update_available;
        });
    }
});
...
var render = function() {
  ...
  return _c("div", { staticClass: "px-3 mb-6 w-full" }, [
      ...
      _c(
        ...
        [
          _c(
            ...
            {
              staticClass:
                "flex flex-col items-center justify-center laravel-bg",
              staticStyle: { "min-height": "118px" }
            },
            [
              _c("div", { staticClass: "px-3 py-3 w-full" }, [
                _c("div", { staticStyle: { "padding-left": "200px" } }, [
                  _vm.currentVersion
                    ? _c("div", [
                        !_vm.updateAvailable
                          ? _c(
                              "h1",
                              { staticClass: "text-3xl text-80 font-light" },
                              [
                                _vm._v(
                          ...
                          : _c(
                              ...
                              {
                                staticClass:
                                  "text-3xl text-error-message font-light"
                              },
                              [
                                _vm._v(
                        ...
                        _vm.latestVersion
                          ? _c("p", { staticClass: "pt-3" }, [
                              ...
                              _vm._v(" "),
                              _c("span", { staticClass: "text-90" }, [
                                _vm._v(_vm._s(_vm.latestVersion))
                              ]),
                              _c("br")
                            ])
                          : _vm._e()
                    ...
                    : _c("div", [
                        _c(
                          ...
                          {
                            staticClass:
                              "text-center text-3xl text-80 font-light"
                          },
                          [
                            _vm._v(
...
var update = __webpack_require__(13)("49c17436", content, false, {});
