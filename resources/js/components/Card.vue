  ...
  <div class="px-3 mb-6 w-full">
    <div class="flex justify-center items-centers">
      <div class="w-full max-w-xl">
        <card
          class="flex flex-col items-center justify-center laravel-bg"
          ...
          <div class="px-3 py-3 w-full">
            <div style="padding-left: 200px">
              <div v-if="currentVersion">
                ...
                <h1
                  class="text-3xl text-error-message font-light"
                  v-else
                >A new version of Laravel is available.</h1>

                <p class="pt-3" v-if="updateAvailable">
                  <span class="text-80">Your version:</span>
                  <span class="text-90">{{ currentVersion}}</span>
                  <br />
                </p>
                <p class="pt-3" v-if="latestVersion">
                  <span class="text-80">Latest version:</span>
                  <span class="text-90">{{ latestVersion}}</span>
                  <br />
                </p>
              </div>
              <div v-else>
                <h1 class="text-center text-3xl text-80 font-light">Checking for Laravel updates...</h1>
              </div>
            </div>
          </div>
        </card>
